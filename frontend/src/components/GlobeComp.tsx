...
export function Globe() {
  const globeConfig = {
    ...
    shininess: 0.9,
    polygonColor: "rgba(255,255,255,0s.7)",
    ambientLight: "#38bdf8",
      ...
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        >
          ...
          <p className="text-center text-base md:text-lg font-normal text-white dark:text-neutral-200 max-w-md mt-2 mx-auto">
            Geopolitics like you've never seen it
          </p>
          <p className="text-center text-base md:text-lg font-normal text-white dark:text-neutral-200 max-w-md mt-2 mx-auto">
            Simulate the inner working of the modern world
          </p>
          <p className="text-center text-base md:text-lg font-normal text-white dark:text-neutral-200 max-w-md mt-2 mx-auto">
            Generative AI to predict the most optimal decision 
          </p>
        </motion.div>
